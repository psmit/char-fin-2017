...
echo ln -s $n  data/lm${lmsuf}/${model}_$mark/${domain}rescore/nnlm.h5.orig
fi
...
echo cp data/lm${lmsuf}/${model}_$mark/${domain}rescore/nnlm.h5.orig data/lm${lmsuf}/${model}_$mark/${domain}rescore/nnlm.h5
fi
